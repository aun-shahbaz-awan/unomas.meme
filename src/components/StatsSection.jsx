...
const StatsSection = () => {
  return (
    <section className="bg-black text-white py-16 luckiest-guy-regular">
      <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-3 items-center gap-12">
        ...
        {/* Second Stat */}
        <div className="flex flex-col items-center border-t pt-8 md:pt-0 px-8 md:border-x-2 border-white">
          <h2 className="text-5xl font-extrabold mb-4">100%</h2>
          <p className="text-center text-lg">
